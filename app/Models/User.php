...
#[Fillable(['name', 'email', 'contact_email', 'password', 'role', 'juragan_id', 'kos_name', 'kos_slug', 'plan', 'room_quota', 'room_number', 'move_in_date', 'phone_number', 'monthly_rate', 'suspended_at', 'mikrotik_host', 'mikrotik_port', 'mikrotik_user', 'mikrotik_pass', 'qris_image', 'bank_accounts'])]
...
class User extends Authenticatable implements FilamentUser
{
    ...
    public function managedMaintenanceTickets(): HasMany
    {
        return $this->hasMany(MaintenanceTicket::class, 'juragan_id');
    }
}
