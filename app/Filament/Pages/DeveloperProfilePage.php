...
class DeveloperProfilePage extends Page implements HasForms
{
    ...
    protected static ?string $title = 'Profil & Rekening NexaSpace';
    ...
    public function infoForm(Schema $schema): Schema
    {
        return $schema
            ->components([
                Section::make('Informasi Akun')
                    ->schema([
                        ...
                        TextInput::make('contact_email')
                            ...
                            ->helperText('Email ini digunakan untuk keperluan komunikasi, bukan untuk login.'),
                    ])
                    ->columns(2),

                Section::make('Rekening Bank NexaSpace')
                    ->description('Rekening yang terdaftar di sini akan muncul di modal pembayaran saat juragan melunasi tagihan langganan bulanan.')
                    ->schema([
                ...
                Section::make('QRIS NexaSpace')
                    ->description('Upload QRIS statis NexaSpace. Akan muncul di halaman pembayaran juragan.')
                    ->schema([
